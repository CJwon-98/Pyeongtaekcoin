#!/usr/bin/env python3
# Copyright (c) 2015-2019 The Pyeongtaekcoin Core developers
...
class InvalidMessagesTest(PyeongtaekcoinTestFramework):
    ...
    def run_test(self):
        ...
        if [s for s in os.environ.get("PYEONGTAEKCOIN_CONFIG", "").split(" ") if "--with-sanitizers" in s and "address" in s]:

...
// pyeongtaekcoin includes.
#include <..\src\script\pyeongtaekcoinconsensus.h>
...
int main()
{
    std::cout << "pyeongtaekcoinconsensus version: " << pyeongtaekcoinconsensus_version() << std::endl;
    ...
    auto op0Result = pyeongtaekcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, pyeongtaekcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);

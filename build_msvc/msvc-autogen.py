...
libs = [
    'libpyeongtaekcoin_cli',
    'libpyeongtaekcoin_common',
    'libpyeongtaekcoin_crypto',
    'libpyeongtaekcoin_server',
    'libpyeongtaekcoin_util',
    'libpyeongtaekcoin_wallet_tool',
    'libpyeongtaekcoin_wallet',
    'libpyeongtaekcoin_zmq',
]

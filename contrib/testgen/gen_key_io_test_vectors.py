...
bech32_templates = [
  ...
  ('ptc',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('ptc',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('ptc',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tptc',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tptc',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tptc',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rptc',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rptc',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rptc', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tptc',  17, 32, False, False, False),
  ('rptc',  3,  1, False, False, False),
  ('ptc',   15, 41, False, False, False),
  ('tptc',  0, 16, False, False, False),
  ('rptc',  0, 32, True,  False, False),
  ('ptc',   0, 16, True,  False, False),
  ('tptc',  0, 32, False, True,  False),
  ('rptc',  0, 20, False, False, True)
]

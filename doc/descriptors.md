...
Since Pyeongtaekcoin Core v0.17, there is support for Output Descriptors. This is a
...
- Followed by the actual key, which is either:
  ...
  - `xpub` encoded extended public key or `xprv` encoded extended private key (as defined in [BIP 32](https://github.com/pyeongtaekcoin/bips/blob/master/bip-0032.mediawiki)).
...
- P2SH addresses (base58, of the form `3...` for mainnet or `2...` for testnet, defined in [BIP 13](https://github.com/pyeongtaekcoin/bips/blob/master/bip-0013.mediawiki)).
- Segwit addresses (bech32, of the form `ptc1...` for mainnet or `tptc1...` for testnet, defined in [BIP 173](https://github.com/pyeongtaekcoin/bips/blob/master/bip-0173.mediawiki)).
...
the entire path from the master down. [BIP174](https://github.com/pyeongtaekcoin/bips/blob/master/bip-0174.mediawiki) standardizes this by
...
All RPCs in Pyeongtaekcoin Core will include the checksum in their output. Only

Pyeongtaekcoin Core version *0.14.3* is now available from:

  <https://pyeongtaekcoin.org/bin/pyeongtaekcoin-core-0.14.3/>
...
- #10451 `3612219` contrib/init/pyeongtaekcoind.openrcconf: Don't disable wallet by default (Luke Dashjr)

Pyeongtaekcoin Core version *0.15.2* is now available from:

  <https://pyeongtaekcoincore.org/bin/pyeongtaekcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in pyeongtaekcoin-tx (TheBlueMatt)

...
public:
     ...
     * https://github.com/pyeongtaekcoin/pyeongtaekcoin/pull/14193 will fix it. No known code
     * in pyeongtaekcoin currently depends on second guarantee, but it is important to

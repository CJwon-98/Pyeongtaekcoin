    ...
    mapper(nullptr)
{
    ...
    ui->pyeongtaekcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->pyeongtaekcoinAtStartup);
    ...
    ui->pyeongtaekcoinAtStartup->setToolTip(ui->pyeongtaekcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->pyeongtaekcoinAtStartup->setText(ui->pyeongtaekcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openPyeongtaekcoinConfButton->setToolTip(ui->openPyeongtaekcoinConfButton->toolTip().arg(PACKAGE_NAME));

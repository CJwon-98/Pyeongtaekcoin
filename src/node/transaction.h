// Copyright (c) 2017-2019 The Pyeongtaekcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef PYEONGTAEKCOIN_NODE_TRANSACTION_H
#define PYEONGTAEKCOIN_NODE_TRANSACTION_H
...
#endif // PYEONGTAEKCOIN_NODE_TRANSACTION_H

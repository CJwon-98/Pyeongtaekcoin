 ...
 */
static const char* PYEONGTAEKCOIN_PID_FILENAME = "pyeongtaekcoind.pid";
...
bool AppInitMain(InitInterfaces& interfaces)
{
    ...
    fs::path config_file_path = GetConfigFile(gArgs.GetArg("-conf", PYEONGTAEKCOIN_CONF_FILENAME));
